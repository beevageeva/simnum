from constants import nint, z0_0, z0_1, zf_0, zf_1, zf_2, z0_2
import numpy as np
...
def getZArray():
	...
	c = np.linspace(z0_2-0.5 *dz1, zf_2+0.5*dz1, nint+2)
...
def displacedPoint(z, c, t, a, b):
	newz = z + c * t
	periodicz = getPeriodicX(newz, a, b)
	return periodicz
